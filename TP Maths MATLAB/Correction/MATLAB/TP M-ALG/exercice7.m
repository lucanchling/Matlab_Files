...
Y=randi([-2 2],1,n); %ordonnées entre -2 et 2
...
%calcul du plan passant au plus près des points perturbés
%résoudre Au=v au sens des moindres carrés
A=[W(:,1),W(:,2)];
v=[a;b;c];
u=inv(A'*A)*A'*v;
